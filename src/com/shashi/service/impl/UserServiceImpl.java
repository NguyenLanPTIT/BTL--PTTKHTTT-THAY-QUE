...
public class UserServiceImpl implements UserService {
	...
	public String registerUser(UserBean user) {
		...
		try {
			System.out.println(user.getAddress()+" "+user.getEmail()+" "+user.getName()+" "+user.getPassword()+" "+user.getPinCode()+" "+user.getPosition()+" "+user.getRole()+" "+user.getMobile());
			ps = conn.prepareStatement("INSERT INTO " + IUserConstants.TABLE_USER + 
				    "(email, name, mobile, address, pincode, password, position) VALUES(?,?,?,?,?,?,?)");
